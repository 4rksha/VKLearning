...
VkPipelineInputAssemblyStateCreateInfo vkinit::inputAssemblyCreateInfo(VkPrimitiveTopology topology, VkBool32 isIndexed) 
{
	...
	info.primitiveRestartEnable = isIndexed;
	return info;
}
...
VkPipelineColorBlendAttachmentState vkinit::colorBlendAttachementState() {
